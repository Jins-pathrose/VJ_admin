...
class Studentscreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const StudentscreenView(),
    );
  }
}

class StudentscreenView extends StatelessWidget {
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: TextField(
              onChanged: (value) {
                context.read<StudentBloc>().add(SearchStudents(value.toLowerCase()));
              },
            ...
            child: BlocBuilder<StudentBloc, StudentState>(
              builder: (context, state) {
                return StreamBuilder<QuerySnapshot>(
                  stream: context.read<StudentBloc>().studentsStream,
